...
@if (session('error'))
    <div id="toast-error" role="alert" aria-live="assertive"
        class="fixed top-6 left-1/2 -translate-x-1/2 z-50 max-w-xs w-full px-4">

        <div
            class="flex items-center gap-4 rounded-2xl bg-red-50 border border-red-200 px-4 py-3 text-sm font-medium text-red-900
               animate-toast-in transition-all duration-300">
