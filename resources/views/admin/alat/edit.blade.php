...
@section('content')
    <div class="max-w-xl mx-auto px-4">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Edit Alat</h1>
                <p class="text-gray-500 mt-1">Ubah data alat</p>
            </div>
        ...
        <div class="bg-white p-6 rounded-xl border shadow-sm">
            <form action="{{ route('admin.alat.update', $alat) }}" method="POST" id="editAlatForm">
                @csrf
                @method('PUT')
    ...
    <script>
        ...
        document.getElementById('resetBtn').addEventListener('click', () => {
            document.getElementById('editAlatForm').reset();
        });
        ...
        confirmModalBtn.addEventListener('click', () => document.getElementById('editAlatForm').submit());
    </script>
@endsection
